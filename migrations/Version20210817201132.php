 ...
 */
final class Version20210817201132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE srscard CHANGE is_activated is_activated TINYINT(1) DEFAULT \'1\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE srscard CHANGE is_activated is_activated TINYINT(1) NOT NULL');
